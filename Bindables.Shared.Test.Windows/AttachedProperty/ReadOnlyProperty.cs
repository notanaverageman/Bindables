...
public abstract partial class WindowsAttachedPropertyTests<T> : TestBase<T> where T : PropertyGeneratorBase, new()
{
	[Test]
...
namespace Test
{
    public partial class ExampleClass
    {
        ...
        static ExampleClass()
        {
            Example1PropertyKey = PropertyType.RegisterAttachedReadOnly(
                ""Example1"",
                typeof(int),
                typeof(ExampleClass),
            ...
            Example2PropertyKey = PropertyType.RegisterAttachedReadOnly(
                ""Example2"",
                typeof(string),
                typeof(ExampleClass),
                new FrameworkPropertyMetadata());
