...
public abstract partial class XamarinTests<T> : TestBase<T> where T : XamarinPropertyGenerator, new()
{
	[Test]
...
{{
    ...
    {{
        ...
        {{
            ...
            Example2PropertyKey = {DependencyPropertyName}.CreateReadOnly(
                ""Example2"",
                typeof(string),
                typeof(ExampleClass),
                default);
            ...
            Example3PropertyKey = {DependencyPropertyName}.CreateAttachedReadOnly(
                ""Example3"",
                typeof(int),
                typeof(ExampleClass),
                default);
            ...
            Example4PropertyKey = {DependencyPropertyName}.CreateAttachedReadOnly(
                ""Example4"",
                typeof(string),
                typeof(ExampleClass),
                default);
